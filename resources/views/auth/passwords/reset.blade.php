...
<head>
  ...
  <title>Library | Recover Password</title>
...
<div class="login-box">
  <div class="login-logo">
   <a href="http://127.0.0.1:8000"><b>MARTA'S</b>Library</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{ route('password.update') }}" method="post">
        ...
        <div class="input-group mb-3 {{ $errors->has('email') ? 'has-error' : '' }}">
          <input id="email" type="email" name="email" class="form-control" placeholder="Email" value="{{ $email ?? old('email') }}">
