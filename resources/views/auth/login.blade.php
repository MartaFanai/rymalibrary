    ...
    <div class="card-body login-card-body">
      ...
      <form action="{{ route('login') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Email" required autofocus>
          @if ($errors->has('email'))
      ...
      <p class="mb-0">
        <a href="{{ route('checking') }}" class="text-center">Register a new user</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
