...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
    	<div class="container">
         <div class="col-md-10">
      <div class="card">
        <div class="card-header bg-primary"><h5>Add New Author</h5></div>
          <div class="card-body">
            ...
            <form method="post" action="{{ route('authors.store') }}">
              ...
              <div class="form-group">
                  <label>Name</label>
                    <input type="text" class="form-control" name="name" placeholder="Enter Author Name" autofocus required />
              </div>
              ...
              <div class="card-footer">
                  ...
                  <a href="{{ Route('authors.index') }}" class="btn btn-secondary"><i class="fas fa-back"></i> Back </a>
              </div>
              </div>
      </div>   
          </form>
