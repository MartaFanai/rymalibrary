...
if (($result = fwrite($fp, $contents))) {
    echo "DATABASE BACK UP SUCCESSFULLY!!!!!";
    echo "Backup file created '--$backup_file_name' ($result)"; 
?>
<script>
    window.location.href = "{{ route('backupredirect')}}";
</script>
<?php
...
$options = array(
    'db_host'=> 'localhost:3308',  //mysql host
    'db_uname' => 'root',  //user
    'db_password' => '', //pass
    'db_to_backup' => 'library', //database name
    'db_backup_path' => 'dbbackup', //where to backup
    'db_exclude_tables' => array("users1") //tables to exclude
);
